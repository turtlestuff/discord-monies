...
namespace MathOlympics
{
    public sealed class DiscordMoniesGameInfo : GameInfo
    {
        ...
        public override string Description => "Монопо́лія — популярна настільна гра у жанрі економічної стратегії, опублікована компанією Parker Brothers (підрозділом компанії Hasbro).";
